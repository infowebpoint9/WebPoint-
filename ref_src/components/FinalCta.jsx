...
export const FinalCta = () => (
    <section className="relative px-3 py-10 sm:px-5" data-testid="final-cta-section">
        <div className="red-panel relative mx-auto max-w-7xl overflow-hidden rounded-[36px] px-6 py-20 sm:px-12 sm:py-28">
            <img
