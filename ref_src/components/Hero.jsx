...
export const Hero = () => {
    ...
    return (
        <section id="home" data-testid="hero-section" className="relative overflow-hidden pb-16 pt-32 sm:pt-40 lg:pb-24 lg:pt-44">
            ...
            <div className="relative mx-auto grid max-w-7xl items-center gap-14 px-5 sm:px-8 lg:grid-cols-[1.05fr_1fr] lg:gap-10">
                <div>
                    ...
                    <h1 className="mt-7 text-4xl font-extrabold leading-[1.06] tracking-tight text-[#FCF4E1] sm:text-5xl lg:text-[3.35rem]">
