...
export const Checklist = () => (
    <section className="relative overflow-hidden py-20 sm:py-28" data-testid="checklist-section">
        <div className="glow-red pointer-events-none absolute left-[-200px] top-1/4 h-[460px] w-[460px]" aria-hidden="true" />
        <div className="relative mx-auto grid max-w-7xl gap-12 px-5 sm:px-8 lg:grid-cols-[1fr_1.2fr] lg:gap-20">
            <div className="lg:sticky lg:top-32 lg:self-start">
                <Reveal>
                    ...
                    <div className="mt-7">
                        <a href="#pricing" data-testid="checklist-cta-btn" className="btn-primary inline-flex items-center gap-2 rounded-full px-6 py-3 text-sm font-semibold">
