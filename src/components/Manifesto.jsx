...
export const Manifesto = () => (
    <section id="service" className="relative py-12 sm:py-16" data-testid="manifesto-section">
        <div className="mx-auto max-w-7xl px-5 sm:px-8">
            <Reveal className="max-w-4xl">
                <span className="eyebrow">What We Do</span>
                <h2 className="mt-3 text-3xl font-bold leading-[1.08] tracking-tight text-[#FCF4E1] sm:text-4xl lg:text-5xl">
                    One Service.{" "}
                    <span className="font-serif-accent font-medium italic">Done Properly.</span>
                </h2>
                <p className="mt-4 max-w-2xl text-base leading-relaxed text-[#B5B0A4] sm:text-lg">
            ...
            <div className="mt-8 sm:mt-10 border-t border-[#FCF4E1]/10">
                {CHAPTERS.map((c, i) => (
                    <Reveal key={c.n} delay={i * 0.08}>
                        <div className="grid gap-3 border-b border-[#FCF4E1]/10 py-5 sm:py-6 sm:grid-cols-[100px_240px_1fr] sm:items-baseline sm:gap-8" data-testid={`manifesto-chapter-${c.n}`}>
