...
*Message:* ${form.message.trim()}`;
    ...
    return (
        <section id="contact" className="relative overflow-hidden py-12 sm:py-16" data-testid="contact-section">
            <div className="glow-red pointer-events-none absolute left-[-160px] bottom-0 h-[420px] w-[420px]" aria-hidden="true" />
            <div className="relative mx-auto grid max-w-7xl gap-8 px-5 sm:px-8 lg:grid-cols-2 lg:gap-14">
                <div>
                    <SectionHeading
                        eyebrow="Contact"
